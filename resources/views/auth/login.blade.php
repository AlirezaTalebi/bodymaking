<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a class="underline text-sm text-white ml-4 hover:text-custom_yellow rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom_yellow" href="{{ route('password.request') }}">
                {{ __('Log in') }}
            </a>
        </div>
    </form>
